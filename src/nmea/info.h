...
/**
 * Enumeration for the mode indicator of GNS
 */
typedef enum _NmeaModeIndicator {
    NMEALIB_MODE_NO_FIX = 'N',
    NMEALIB_MODE_AUTONOMOUS = 'A',
    NMEALIB_MODE_DIFFERENTIAL = 'D',
    NMEALIB_MODE_PRECISE = 'P',
    NMEALIB_MODE_REAL_TIME_KINEMATIC = 'R',
    NMEALIB_MODE_FLOAT_RTK = 'F',
    NMEALIB_MODE_ESTIMATED = 'E',
    NMEALIB_MODE_MANUAL_INPUT = 'M',
    NMEALIB_MODE_SIMULATOR = 'S'
} NmeaModeIndicator;

/**
 * Enumeration for the navigation status of GNS
 */
typedef enum _NmeaNavigationStatus {
    NMEALIB_NAV_STATUS_SAFE = 'S',
    NMEALIB_NAV_STATUS_CAUTION = 'C',
    NMEALIB_NAV_STATUS_UNSAFE = 'U',
    NMEALIB_NAV_STATUS_NOT_VALID = 'V'
} NmeaNavigationStatus;
