 ...
 *
 * | NmeaInfo field       | GPGGA | GPGSA | GPGSV | GPRMC | GPVTG |[XX]GNS|
 * | :------------------- | :---: | :---: | :---: | :---: | :---: | :---: |
 * | present              | x     | x     | x     | x     | x     | x     |
 * | smask                | x     | x     | x     | x     | x     | x     |
 * | utc (date)           |       |       |       | x     |       |       |
 ...
 *     set yet.
 * (4) Signal for GNS is a mode, indicating the type of tracking used to give lat/long
 */
...
typedef enum _NmeaSentence {
  ...
  NMEALIB_SENTENCE_GNGNS = (1u << 5),
  //NMEALIB_SENTENCE_GPGNS = (1u << 6),
  //NMEALIB_SENTENCE_GLGNS = (1u << 7),
...
#define NMEALIB_PREFIX_LENGTH 6
...
static const NmeaSentencePrefixToType nmealibSentencePrefixToType[] = {
    ...
    {
        .prefix = NMEALIB_GNGNS_PREFIX, //
        .sentence = NMEALIB_SENTENCE_GNGNS //
    },
    {
        .prefix = NULL, //
